...
export default function StoreOwner() {
  ...
  const getStoreOwners = async () => {
    ...
    try {
      let res = await PostAPI("admin/getZoneWiseStoreOwners", requestPayload);
      if (res?.data?.status === "1") {
        setData(res?.data);
      } else {
        setData({ data: [] });
      ...
      setData({ data: [] });
      error_toaster("Failed to fetch store owners");
    }
    setLoading(false);
  };
  ...
  const initializeFilters = async () => {
    try {
      ...
      } else if (filterOptions?.data?.city) {
      ...
      } else if (filterOptions?.data?.zones) {
  ...
  // Fallback initialization when filterOptions becomes available
  React.useEffect(() => {
  ...
  const ownerData = () => {
    const filteredData = data?.data?.filter((dat) => {
      return (
        ...
        (dat?.user?.email &&
          dat?.user?.email.toString().includes(search.toLowerCase())) ||
        (dat?.user?.firstName &&
          ...
          <div className="bg-white rounded-lg p-5">
            <div className="flex justify-between items-center flex-wrap gap-5">
              ...
              <div className="flex gap-x-2">
                <div data-testid="storeowner-helment">
                  <Helment
                    search={true}
                ...
                <div className="flex gap-2" data-testid="storeowner-addowner-btn">
                  <HelmetBtn text={t("Add Store Owner")} onClick={openModal} />
                </div>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        name="firstName"
                        id="firstName"
                        data-testid="storeowner-modal-firstname-input"
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        name="lastName"
                        id="lastName"
                        data-testid="storeowner-modal-lastname-input"
                        className="bg-themeInput w-full h-10 px-3 rounded-md outline-none"
                        onChange={handleOnEventChange}
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        name="email"
                        id="email"
                        data-testid="storeowner-modal-email-input"
                        className="bg-themeInput w-full h-10 px-3 rounded-md outline-none"
                        onChange={handleOnEventChange}
                        value={addUser?.email}
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="col-span-1">
                          <div data-testid="storeowner-modal-countrycode-input">
                            <PhoneInput
                              country={"pk"}
                              inputStyle={{
                                width: "100%",
                    ...
                    <div className="space-y-1 col-span-2 relative">
                      ...
                      <div className="relative">
                        <input
                          ...
                          name="password"
                          id="password"
                          data-testid="storeowner-modal-password-input"
                        ...
                        <button
                          ...
                          tabIndex={-1} // so it doesn't take focus in tab order
                          data-testid="storeowner-modal-password-toggle-btn"
                        >
                    ...
                    <div className="space-y-1 col-span-2">
                      ...
                      <Select
                        ...
                        data-testid="storeowner-role-select-input"
                      />
                    </div>

                    <div className="flex justify-end col-span-2 gap-2">
                      <div data-testid="storeowner-modal-cancel-btn">
                        <BlackButton
                          text={t("Cancel")}
                          onClick={() => {
                            setModal(false);
                      ...
                      <div data-testid="storeowner-modal-add-btn">
              ...
              <ModalBody padding={4}>
                <div className="space-y-5">
                  <div className="space-y-1">
                    ...
                    <Select
                      data-testid="storeowner-filter-country-select-input"
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      data-testid="storeowner-filter-city-select-input"
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      data-testid="storeowner-filter-zone-select-input"
                  ...
                  <div className="flex justify-end gap-2">
                    <div data-testid="storeowner-filter-clear-btn">
                      <BlackButton
                        text={t("Clear All")}
                        onClick={() => {
                          setTempFilterData({
                    ...
                    <div data-testid="storeowner-filter-apply-btn">
                      <RedButton
                        text={t("Apply Filter")}
                        onClick={() => {
