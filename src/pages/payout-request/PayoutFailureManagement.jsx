...
const PayoutFailureManagement = () => {
    ...
    const datas = [{
        ...
        userName: "Ahsan",
        role: "Retailer",
        failedAmount: "68/87/99",
        dateOfFailure: 34343,
        action: <div className='flex gap-x-2 [&>button]:rounded-md font-normal font-norms [&>button]:border-[1px] [&>button]:px-4 [&>button]:py-1.5'>
            <button className='text-green-600 border-green-600'>Retry Payout</button>
            <button className='text-orange-400 border-orange-400'>Update Details</button>
        </div>
    }];
...
export default PayoutFailureManagement