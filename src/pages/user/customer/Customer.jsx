...
export default function Customer() {
  ...
  const [roleId, setRoleId] = useState({ value: 1, label: "Customer" });
  ...
  const roleOptions = [{ value: 1, label: "Customer" }];
  ...
  customerData()?.map((values, index) => {
    csv.push({
      ...
      status: values?.status === "Active" ? t("active") : t("inactive"),
            ...
            <div className="flex justify-between items-center flex-wrap gap-5">
              ...
              <div className="flex gap-x-2">
                ...
                <div className="flex gap-2">
                  ...
                  <HelmetBtn text={t("Add Customer")} onClick={openModal} />
                </div>
              </div>
            </div>
