...
export default function Cuisines() {
  ...
  const restaurant = GetAPI("admin/getallrestaurants/restaurant");
  ...
  const addNewCuisines = async () => {
    if (addCuisine?.image === "") {
      info_toaster(t("addCuisineImageWarning"));
    } else if (addCuisine?.name === "") {
      info_toaster(t("addCuisineNameWarning"));
    } else {
      setLoader(true);
            ...
            <div className="flex justify-between items-center flex-wrap gap-5">
              ...
              <div className="flex gap-2 items-center flex-wrap">
                ...
                <div className="flex gap-2">
                  <RedButton
                    text={t("addNewCuisine")}
                    onClick={() => openModal(t("addNewCuisine"))}
                  />
                </div>
              </div>
            </div>
