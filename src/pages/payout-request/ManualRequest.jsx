...
const ManualRequest = () => {
    ...
    const datas = [{
        ...
        requestDate: 34343,
        status: <span className='text-orange-500 bg-orange-100 px-4 py-2.5 rounded-sm cursor-pointer' >Pending</span>,
        action: <div className='flex gap-x-2 [&>button]:rounded-md font-normal font-norms [&>button]:border-[1px] [&>button]:px-4 [&>button]:py-1.5'>
            <button className='text-green-600 border-green-600'>Approved</button>
            <button className='text-orange-400 border-orange-400'>Adjust</button>
            <button className='text-red-500 border-red-500'>Reject</button>
        </div>
    }];
